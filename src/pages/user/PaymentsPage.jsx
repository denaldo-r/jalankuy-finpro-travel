...
import { Upload, X, CheckCircle, ImageUp } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {/* Activity Summary - Left Side */}
          <div className="bg-white rounded-2xl shadow-lg p-8 transition-all hover:shadow-xl h-fit">
            <h2 className="text-xl font-bold mb-6 text-gray-900">Your Order</h2>
