...
const TransactionsPage = () => {
  ...
  // We'll show 6 transactions per page
  ...
  // Sort transactions by latest orderDate first
  const sortedTransactions = transactions.sort(
    (a, b) => new Date(b.orderDate) - new Date(a.orderDate)
  );

  // Pagination logic: Calculate the current slice of transactions
      ...
      <div className="max-w-7xl mx-auto py-12 px-4">
        ...
        <div className="space-y-4">
          {currentTransactions.map((transaction) => (
            <div
              ...
              className="flex items-center gap-4 p-4 bg-white rounded-xl hover:bg-gray-100 transition cursor-pointer"
            >
        ...
        <div className="flex justify-center items-center mt-8 space-x-4">
          <button
            ...
            className="p-2 bg-blue-600 text-white rounded-full hover:bg-blue-800 disabled:opacity-50"
          >
