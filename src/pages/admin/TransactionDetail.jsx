        ...
        <div className="bg-gray-200 rounded-xl shadow-lg p-6">
          ...
          <div className="mt-4">
            ...
            {transaction.proofPaymentUrl ? (
              ...
              <p className="text-gray-700 mt-2">Tidak ada bukti pembayaran</p>
            )}
          </div>
          <div className="mt-4">
            <h3 className="text-xl font-bold text-gray-900">
            ...
            {transaction.status === "pending" ? (
              <>
                <select
                  ...
                  className="p-2 rounded bg-gray-300 text-gray-900 w-full mt-2"
                >
              ...
              <p className="text-gray-700 mt-2">{transaction.status}</p>
            )}
          </div>
          {transaction.status === "pending" && (
            <div className="mt-4">
